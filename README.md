...
{
  "coordinates": [
    [[-122.4194, 37.7749], [-122.4094, 37.7749], 
     [-122.4094, 37.7649], [-122.4194, 37.7649], 
     [-122.4194, 37.7749]]
  ],
...
### Historical Comparison
```
POST /api/historical-comparison
Content-Type: application/json

{
  "coordinates": [[...]],
  "current_start": "2024-10-01",
  "current_end": "2024-11-01",
  "years_back": 1
}
```
...

{
  ...
  "query": "What should I do to improve my crop yield?"
}
```
